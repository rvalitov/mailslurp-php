...
class UserControllerApi
{
     ...
     */
    public function getUserUsingGET($jwt_token)
    {
        list($response) = $this->getUserUsingGETWithHttpInfo($jwt_token);
        return $response;
    }
     ...
     */
    public function getUserUsingGETWithHttpInfo($jwt_token)
    {
        $returnType = '\Swagger\Client\Model\UserDto';
        $request = $this->getUserUsingGETRequest($jwt_token);
     ...
     */
    public function getUserUsingGETAsync($jwt_token)
    {
        return $this->getUserUsingGETAsyncWithHttpInfo($jwt_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserUsingGETAsyncWithHttpInfo($jwt_token)
    {
        $returnType = '\Swagger\Client\Model\UserDto';
        $request = $this->getUserUsingGETRequest($jwt_token);
     ...
     */
    protected function getUserUsingGETRequest($jwt_token)
    {
        // verify the required parameter 'jwt_token' is set
        if ($jwt_token === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $jwt_token when calling getUserUsingGET'
            );
        }
